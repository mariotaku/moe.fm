...
public final class HttpResponseEvent {
	...
	private final MoefouException twitterException;

	HttpResponseEvent(final HttpRequest request, final HttpResponse response, final MoefouException te) {
	 ...
	 */
	public MoefouException getTwitterException() {
